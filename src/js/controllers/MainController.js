...
wfApp.controller('MainController', [
    ...
    '$rootScope',
    '$location',
    'cfpLoadingBar', function MainController(wfService, keyboardService,
                                             wayfinder, toggleNavMenu, hideNavMenu, showNavMenu, $scope, $timeout, $rootScope, $location, cfpLoadingBar) {
        $scope = $rootScope;
